...
Popup.propTypes = {
  orderPopup: PropTypes.bool.isRequired, // Validates that orderPopup is a required boolean
  handleOrderPopup: PropTypes.func.isRequired, // Validates that handleOrderPopup is a required function
};
